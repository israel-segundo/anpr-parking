...
<html>
  <head>
    ...
    <title>Editar información de auto</title>
  ...
  <body>
    ...
    <div class="navigation-bar">
      ...
      <g:link controller="person" action="edit" id="${car.person.id}">Personas</g:link> -
      Editar auto
    </div>
    ...
    <div id="contenido">
      ...
      <g:form name="editForm" action="edit_store">
        ...
        <g:hiddenField name="personId" value="${car.person.id}" />
        ...
        <table>
          ...
          <tr>
            ...
            <td>
              <g:select name="carModel"
                        from="${car.carModel.maker.carModels}"
          ...
          <tr>
            <td>Año</td>
            <td><g:textField class="required" name="year" value="${car.year}"/></td>
          </tr>

          <tr>
            <td>Placas</td>
            <td><g:textField class="required" name="plateNumber" value="${car.plateNumber}"/></td>
          </tr>

          <tr>
            <td colspan="2"><g:submitButton class="submit" name="add" value="Editar" /></td>
          </tr>
        </table>
