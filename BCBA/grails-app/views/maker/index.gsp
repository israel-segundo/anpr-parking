...
<html>
  <head>
    ...
    <title>Catálogo de Fabricantes de Autos</title>
  ...
  <body>
    ...
    <div class="navigation-bar">
      <g:link controller="catalogue" action="index">Catálogos </g:link>- Fabricantes de Autos
    </div>

    <h1>Catálogo de Fabricantes de Autos</h1>
        ...
        <div>
          <table id="myTable" class="tablesorter">
            ...
            <tbody>
              ...
              <g:each var="maker" in="${makers}">

                <tr>
                    <td>${ maker.id }</td>
                    <td>${maker.description }</td>
                    <td>${maker.dateCreated}</td>
                    <td>${ maker.lastUpdated}</td>
                    <td>
                        <g:link controller="maker" action="edit" id="${maker.id}">
                           <img src="${resource(dir:'images/icons',file:'118799_36369_32_edit_report_icon.png')}" title="Editar" alt="Editar" />
                        </g:link>

                        <g:link class="delete_link" controller="maker" action="delete" id="${maker.id}">
