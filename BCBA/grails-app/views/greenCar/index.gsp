...
<html>
  <head>
    ...
    <title>Catálogo de Autos Ecológicos o Green Cars</title>
  ...
  <body>
    ...
    <h1>Catálogo de Autos Ecológicos o Green Cars</h1>
        ...
        <div>
          <table id="myTable" class="tablesorter">
            ...
            <tbody>
              ...
              <g:each var="greenCar" in="${greenCars}">

                <tr>
                    <td>${greenCar.id}</td>
                    <td>${greenCar.carModel.maker.description}</td>
                    <td>${greenCar.carModel.description}</td>
                    <td>${greenCar.year}</td>
                    <td>${greenCar.dateCreated}</td>
                    <td>${greenCar.lastUpdated}</td>
                    <td>
                        <g:link controller="greenCar" action="edit" id="${greenCar.id}">
                           <img src="${resource(dir:'images/icons',file:'118799_36369_32_edit_report_icon.png')}" title="Editar" alt="Editar" />
                        </g:link>

                        <g:link class="delete_link" controller="greenCar" action="delete" id="${greenCar.id}">
